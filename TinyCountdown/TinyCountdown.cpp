...
// Comment:
//
// This function saves the instance handle as a global variable and
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   hInst = hInstance; // グローバル変数にインスタンス処理を格納します。// Store instance processing in a global variable.
   ...
   // hide from task bar
   // https://github.com/whosa/TinyCountDown/commit/f8d1ed296c21de221a83f77d09722a585f33fee2
